...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(point) => "הנקודות הזמינות שלך: ${point}";

  static String m1(day) => "לפני ";

  static String m2(timeLeft) => "מסתיים בעוד ${timeLeft}";

  static String m3(message) => "שגיאה: ${message}";

  static String m4(time) => "יפוג בעוד ${time}";

  static String m5(hour) => "לפני ";

  static String m6(message) =>
      "יש בעיה באפליקציה במהלך בקשת הנתונים, אנא פנה למנהל לתיקון הבעיות: ${message}";

  static String m7(size) => "גודל קובץ מקסימלי: ${size} מגה בייט";

  static String m8(minute) => "לפני ";

  static String m9(itemCount) => "${itemCount} פריטים";

  static String m10(price) => "סה\"כ אפשרויות: ${price}";

  static String m11(percent) => "הנחה ${percent}%";

  static String m12(second) => "לפני ${second} שניות";

  static String m13(totalCartQuantity) =>
      "עגלת קניות, ${totalCartQuantity} פריטים";

  static String m14(numberOfUnitsSold) => "נמכר: ${numberOfUnitsSold}";

  static String m15(total) => "${total} מוצרים";
  ...
  static String m19(week) => "שבוע ${week}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addToCartSucessfully":
            MessageLookupByLibrary.simpleMessage("נוסף לעגלתך"),
        "addedSuccessfully":
        ...
        "currentlyWeOnlyHave":
            MessageLookupByLibrary.simpleMessage("כרגע יש לנו רק"),
        ...
        "date": MessageLookupByLibrary.simpleMessage("מומלץ"),
        ...
        "done": MessageLookupByLibrary.simpleMessage("סיים"),
        "dontHaveAccount":
        ...
        "emptyCartSubtitle": MessageLookupByLibrary.simpleMessage(
            "נראה שעדיין לא הוספת פריטים לעגלה. התחל לקנות כדי למלא אותה."),
        "emptyUsername":
        ...
        "featured": MessageLookupByLibrary.simpleMessage("פופולארי"),
        ...
        "itsOrdered": MessageLookupByLibrary.simpleMessage("ההזמנה התקבלה!"),
        ...
        "myWishList": MessageLookupByLibrary.simpleMessage("המשאלות שלי"),
        "nItems": m9,
        ...
        "shoppingCartItems": m13,
        "shortDescription": MessageLookupByLibrary.simpleMessage("תיאור קצר"),
        "showAllMyOrdered":
            MessageLookupByLibrary.simpleMessage("הצג את כל ההזמנות שלי"),
